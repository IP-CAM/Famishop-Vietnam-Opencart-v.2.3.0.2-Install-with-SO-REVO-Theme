...
class ControllerPagePageRequest extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('page/page_request', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('page/page_request', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('page/page_request/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('page/page_request/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['page_requests'][] = array(
				...
				'view'           	=> $this->url->link('page/page_request/info', 'token=' . $this->session->data['token'] . '&page_request_id=' . $result['page_request_id'] . $url, true)
			);
		}
		...
		$data['sort_title'] = $this->url->link('page/page_request', 'token=' . $this->session->data['token'] . '&sort=pg.page_form_title' . $url, true);
		$data['sort_customer'] = $this->url->link('page/page_request', 'token=' . $this->session->data['token'] . '&sort=customer' . $url, true);
		$data['sort_ip'] = $this->url->link('page/page_request', 'token=' . $this->session->data['token'] . '&sort=pg.ip' . $url, true);
		$data['sort_date_added'] = $this->url->link('page/page_request', 'token=' . $this->session->data['token'] . '&sort=pg.date_added' . $url, true);
		...
		$pagination->url = $this->url->link('page/page_request', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
	...
	public function info() {
		...
		if ($page_request_info) {
			...
			$data['back'] = $this->url->link('page/page_request', 'token=' . $this->session->data['token'] . $url, true);
			...
			if ($page_request_info['customer_id']) {
				$data['customer'] = $this->url->link('customer/customer/edit', 'token=' . $this->session->data['token'] . '&customer_id=' . $page_request_info['customer_id'], true);
			} else {
				$data['customer'] = '';
			}

			if ($page_request_info['page_form_id']) {
				$data['page_form_href'] = $this->url->link('page/page_form/edit', 'token=' . $this->session->data['token'] . '&page_form_id=' . $page_request_info['page_form_id'], true);
			} else {
				$data['page_form_href'] = '';
			}
			...
			foreach($page_request_options as $page_request_option) {
				...
				$data['page_request_options'][] = array(
					...
					'value'		=> $page_request_option['value'],
