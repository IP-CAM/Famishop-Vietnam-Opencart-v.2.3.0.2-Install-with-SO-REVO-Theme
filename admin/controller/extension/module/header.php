<?php
require_once (DIR_TEMPLATE.DIRECTORY_SEPARATOR.'so_page_builder'.DIRECTORY_SEPARATOR.'data.php');
require_once (DIR_TEMPLATE.DIRECTORY_SEPARATOR.'so_page_builder'.DIRECTORY_SEPARATOR.'addElement.php');
require_once (DIR_TEMPLATE.DIRECTORY_SEPARATOR.'so_page_builder'.DIRECTORY_SEPARATOR.'formField.php');
require_once (DIR_TEMPLATE.DIRECTORY_SEPARATOR.'so_page_builder'.DIRECTORY_SEPARATOR.'shortcodes-func.php');


class ControllerExtensionModuleHeader extends Controller {
	private $error = array();
	private $data = array();
