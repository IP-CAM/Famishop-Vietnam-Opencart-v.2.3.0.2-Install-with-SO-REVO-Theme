...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.extraPlugins = 'fontawesome,leaflet,accordion';
    ...
    config.toolbar = [
        ...
        { name: 'insert', items: [ 'Image', 'Slideshow', 'Table', 'HorizontalRule', 'PageBreak', 'Iframe', '-', 'Glyphicons', 'FontAwesome', 'Accordion' ,'Symbol', 'SpecialChar', '-', 'leaflet', 'embed', 'Youtube', 'videosnapshot', 'Html5video', 'Flash', '-', 'WidgetcommonQuotebox', 'WidgetcommonBox', 'Smiley', 'qrc' ] },
        '/',
