            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo $page_form['status']; ?></td>
                  <td class="text-right"><?php echo $page_form['sort_order']; ?></td>
                  <td class="text-right"><a href="<?php echo $page_form['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
