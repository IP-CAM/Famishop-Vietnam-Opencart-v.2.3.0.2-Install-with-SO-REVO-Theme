...
<div id="content">
                  ...
                  <?php $field_row = 0; ?>
                    ...
                    <div class="tab-pane" id="tab-field<?php echo $field_row; ?>">
                        ...
                        <div class="field-group">
                          ...
                          <div class="tab-content">
                            ...
                            <div class="tab-pane" id="field-language<?php echo $field_row; ?>-<?php echo $language['language_id']; ?>">
                              <div class="form-group required">
                                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_field_name; ?>"><?php echo $entry_field_name; ?></span></label>
                                <div class="col-sm-10">
                              ...
                              <div class="form-group field-placeholder<?php echo $field_row; ?>">
                                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_field_placeholder; ?>"><?php echo $entry_field_placeholder; ?></span></label>
                                <div class="col-sm-10">
                              ...
                              <div class="form-group field-error<?php echo $field_row; ?>">
                                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_field_error; ?>"><?php echo $entry_field_error; ?></span></label>
                                <div class="col-sm-10">
                      ...
                      <fieldset>
                        ...
                        <div class="form-group">
                          <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_required; ?>"><?php echo $entry_required; ?></span></label>
                          <div class="col-sm-10">
                        ...
                        <div class="form-group">
                          <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_type; ?>"><?php echo $entry_type; ?></span></label>
                          <div class="col-sm-10">
  ...
  function addField() {
    ...
    $('#tab-field .tab-content').append(html);
 
    $('#pageformfields > li:last-child').before('<li class="pageformfields-li"><a href="#tab-field' + field_row + '" data-toggle="tab"><i class="fa fa-minus-circle" onclick=" $(\'#pageformfields a:first\').tab(\'show\');$(\'a[href=\\\'#tab-field' + field_row + '\\\']\').parent().remove(); $(\'#tab-field' + field_row + '\').remove();"></i> <?php echo $tab_field; ?> - '+ (field_row + 1) +'</li>');
  ...
  html = '<div class="tab-pane" id="tab-field' + field_row + '">';
        ...
        html += '<div class="tab-content">';
          ...
          html += '<div class="tab-pane" id="field-language' + field_row + '-<?php echo $language['language_id']; ?>">';
            html += '<div class="form-group required">';
              html += '<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_field_name; ?>"><?php echo $entry_field_name; ?></span></label>';
            ...
            html += '<div class="form-group field-placeholder' + field_row + '">';
              html += '<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_field_placeholder; ?>"><?php echo $entry_field_placeholder; ?></span></label>';
              html += '<div class="col-sm-10">';
            ...
            html += '<div class="form-group field-error' + field_row + '">';
              html += '<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_field_error; ?>"><?php echo $entry_field_error; ?></span></label>';
              html += '<div class="col-sm-10">';
    ...
    html += '<fieldset>';
      html += '<legend><?php echo $text_type_setting ?></legend>';
          ...
          html += '</div>';
          html += '<div class="form-group">';
            html += '<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_required; ?>"><?php echo $entry_required; ?></span></label>';
            html += '<div class="col-sm-10">';
          ...
          html += '</div>';
          html += '<div class="form-group">';
            html += '<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_type; ?>"><?php echo $entry_type; ?></span></label>';
            html += '<div class="col-sm-10">';
