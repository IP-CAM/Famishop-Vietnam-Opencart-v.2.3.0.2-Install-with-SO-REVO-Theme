      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-category">
        <div class="table-responsive">
         <table class="table table-bordered table-hover">
          ...
          <tbody>
            <?php if ($recruit_categories) { ?>
            <?php foreach ($recruit_categories as $recruit_category) { ?>
            <tr>
              <td style="text-align: center;"><?php if ($recruit_category['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $recruit_category['recruit_category_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $recruit_category['recruit_category_id']; ?>" />
                <?php } ?></td>
              <td><?php echo $recruit_category['name']; ?></td>
              <td class="text-right"><?php echo $recruit_category['sort_order']; ?></td>
              <td class="text-right">
              <?php if($recruit_category['status']){ ?>
            ...
            <?php } ?>
              ...
              <td class="text-right">
                <a href="<?php echo $recruit_category['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                </td>
            </tr>
            <?php } ?>
            <?php } else { ?>
