    ...
    <div class="panel panel-default">
      ...
      <div class="table-responsive">
        ...
        <tbody>
          ...
          <tr>
            <td style="text-align: center;"><?php if ($recruit['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $recruit['recruit_id']; ?>" checked="checked" />
              <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $recruit['recruit_id']; ?>" />
              <?php } ?></td>
            <td><?php echo $recruit['title']; ?></td>
            <td><?php echo $recruit['date_added']; ?></td>

            <td class="text-right"><?php echo $recruit['comment_total']; ?></td>
            <td class="text-right"><?php echo $recruit['count_read']; ?></td>
            <td class="text-right"><?php echo $recruit['sort_order']; ?></td>
            <td class="text-right">
            <?php if($recruit['status']){ ?>
            ...
            <td class="text-right"><a href="<?php echo $recruit['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>
