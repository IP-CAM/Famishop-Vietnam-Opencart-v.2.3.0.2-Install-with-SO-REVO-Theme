        ...
        <div class="table-responsive">
          <table class="table table-bordered table-hover">
            ...
            <td class="text-right"><?php echo $column_status; ?></td>
     		...
     		<tbody>
     		<?php if ($recruit_comments) { ?>
     		<?php foreach ($recruit_comments as $recruit_comment) { ?>
     		<tr>
            <td>
            <input type="checkbox" name="selected[]" value="<?php echo $recruit_comment['recruit_comment_id'];?>">
            </td>
            <td><?php echo $recruit_comment['comment']; ?></td>
             <td class="left"><?php echo $recruit_comment['title']; ?></td>
            <td><?php echo $recruit_comment['name']; ?><br />(<?php echo $recruit_comment['email']; ?>)</td>
            <td class="text-right"><?php echo $recruit_comment['date_added']; ?></td>
            <td class="text-right">
            <?php if($recruit_comment['status']){ ?>
