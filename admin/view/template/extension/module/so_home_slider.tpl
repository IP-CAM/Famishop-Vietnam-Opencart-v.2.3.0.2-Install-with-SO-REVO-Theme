							...
							<div class="tab-content">
								...
								<div  id="tab-module<?php echo $module_row; ?>" class="col-sm-12">
									...
									<div class="form-group"> <?php //<!--center --> ?>
										<label class="col-sm-3 control-label" for="input-center"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_center_desc'); ?>"><?php echo $objlang->get('entry_center'); ?></span></label>
										<div class="col-sm-9">
											<div class="col-sm-5">
