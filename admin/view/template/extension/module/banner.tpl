    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-height"><?php echo $entry_column; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-height">Margin</label>
            <div class="col-sm-10">
              <input type="text" name="margin" value="<?php echo $margin; ?>" placeholder="margin" id="input-margin" class="form-control" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="style" id="input-style" class="form-control">
                ...
                <option value="2"  selected="selected">Style 2</option>
                <option value="3">default</option>
                <?php } else { ?>
                  <option value="1">Style 1</option>
                  <option value="2">Style 2</option>
