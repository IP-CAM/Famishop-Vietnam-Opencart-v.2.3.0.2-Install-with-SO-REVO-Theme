    ...
    <div class="panel panel-default">
      ...
      <div class="table-responsive">
        ...
        <tbody>
          ...
          <tr>
            <td style="text-align: center;"><?php if ($dieutri['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $dieutri['dieutri_id']; ?>" checked="checked" />
              <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $dieutri['dieutri_id']; ?>" />
              <?php } ?></td>
            <td><?php echo $dieutri['title']; ?></td>
            <td><?php echo $dieutri['date_added']; ?></td>

            <td class="text-right"><?php echo $dieutri['comment_total']; ?></td>
            <td class="text-right"><?php echo $dieutri['count_read']; ?></td>
            <td class="text-right"><?php echo $dieutri['sort_order']; ?></td>
            <td class="text-right">
            <?php if($dieutri['status']){ ?>
            ...
            <td class="text-right"><a href="<?php echo $dieutri['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>
