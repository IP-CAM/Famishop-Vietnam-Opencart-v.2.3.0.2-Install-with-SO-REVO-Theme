        ...
        <div class="table-responsive">
          <table class="table table-bordered table-hover">
            ...
            <td class="text-right"><?php echo $column_status; ?></td>
     		...
     		<tbody>
     		<?php if ($dieutri_comments) { ?>
     		<?php foreach ($dieutri_comments as $dieutri_comment) { ?>
     		<tr>
            <td>
            <input type="checkbox" name="selected[]" value="<?php echo $dieutri_comment['dieutri_comment_id'];?>">
            </td>
            <td><?php echo $dieutri_comment['comment']; ?></td>
             <td class="left"><?php echo $dieutri_comment['title']; ?></td>
            <td><?php echo $dieutri_comment['name']; ?><br />(<?php echo $dieutri_comment['email']; ?>)</td>
            <td class="text-right"><?php echo $dieutri_comment['date_added']; ?></td>
            <td class="text-right">
            <?php if($dieutri_comment['status']){ ?>
