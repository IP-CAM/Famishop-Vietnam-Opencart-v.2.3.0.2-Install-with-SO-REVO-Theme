      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-category">
        <div class="table-responsive">
         <table class="table table-bordered table-hover">
          ...
          <tbody>
            <?php if ($dieutri_categories) { ?>
            <?php foreach ($dieutri_categories as $dieutri_category) { ?>
            <tr>
              <td style="text-align: center;"><?php if ($dieutri_category['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $dieutri_category['dieutri_category_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $dieutri_category['dieutri_category_id']; ?>" />
                <?php } ?></td>
              <td><?php echo $dieutri_category['name']; ?></td>
              <td class="text-right"><?php echo $dieutri_category['sort_order']; ?></td>
              <td class="text-right">
              <?php if($dieutri_category['status']){ ?>
            ...
            <?php } ?>
              ...
              <td class="text-right">
                <a href="<?php echo $dieutri_category['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                </td>
            </tr>
            <?php } ?>
            <?php } else { ?>
