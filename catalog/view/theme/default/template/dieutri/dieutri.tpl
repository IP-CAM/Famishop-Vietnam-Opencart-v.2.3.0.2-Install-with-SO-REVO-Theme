...
<div class="container">
  ...
  <?php echo $column_left; ?>
   ...
   <div class="padded main">
    ...
    <?php if($main_thumb && $dieutrisetting_post_thumb){ ?>
    <div class="image">
    <img src="<?php echo $dieutrisetting_post_thumb; ?>" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" />
    </div>
    <?php } ?>
   ...
   <span class="text"><?php echo $text_share_this;?></span>
    ...
    <?php if ($related_dieutris) { ?>
		<h3><?php echo $text_related_dieutri; ?></h3>
		<div class="bordered_content box">
        <div class="grid_holder grid<?php echo $rel_per_row; ?> list">
		<div class="product-grid latest_dieutris <?php if ($rel_per_row > 1) { echo 'eq_height'; } ?>">
            <?php foreach ($related_dieutris as $dieutri) { ?>
				<div class="item dieutri_post">
                <?php if(($dieutri['image']) && ($rel_thumb_status)){ ?>
              ...
              <form id="comment_form">
                ...
                <div class="col-sm-12">
                  ...
                  <label class="control-label" for="input-captcha_comment"><?php echo $entry_captcha; ?></label>
                    ...
                    <span class="input-group-addon captcha_wrap"><img src="index.php?route=dieutri/dieutri/captcha" alt="" id="captcha_comment" /></span>
...
$('#comment').load('index.php?route=dieutri/dieutri/comment&dieutri_id=<?php echo $dieutri_id; ?>');
//--></script>
...
$('#button-comment').on('click', function() {
	$.ajax({
		url: 'index.php?route=dieutri/dieutri/write&dieutri_id=<?php echo $dieutri_id; ?>',
		type: 'post',
		dataType: 'json',
		...
		complete: function() {
			...
			$('#captcha_comment').attr('src', 'index.php?route=dieutri/dieutri/captcha#'+new Date().getTime());
