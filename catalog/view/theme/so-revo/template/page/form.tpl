            ...
            <?php foreach ($page_form_options as $page_form_option) { ?>
              <?php if ($page_form_option['type'] == 'select') { ?>
                <div class="form-group<?php echo ($page_form_option['required'] ? ' required' : ''); ?>">
                  <label class="control-label col-sm-2" for="input-field<?php echo $page_form_option['page_form_option_id']; ?>"><?php echo $page_form_option['field_name']; ?></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group<?php echo ($page_form_option['required'] ? ' required' : ''); ?>">
                  <label class="control-label col-sm-2"><?php echo $page_form_option['field_name']; ?></label>
                  <div class="col-sm-10">
