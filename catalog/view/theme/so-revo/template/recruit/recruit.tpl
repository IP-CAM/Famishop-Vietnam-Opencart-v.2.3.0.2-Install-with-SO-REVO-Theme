...
<div class="container">
  ...
  <div class="row">
   ...
   <div class="padded main">
    ...
    <?php if($main_thumb && $recruitsetting_post_thumb){ ?>
    <div class="image">
    <img src="<?php echo $recruitsetting_post_thumb; ?>" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" />
    </div>
    <?php } ?>
   ...
   <span class="text"><?php echo $text_share_this;?></span>
    ...
    <?php if ($related_recruits) { ?>
		<h3><?php echo $text_related_recruit; ?></h3>
		<div class=" box">
        <div class="grid_holder grid<?php echo $rel_per_row; ?> list">
		<div class="product-grid latest_recruits <?php if ($rel_per_row > 1) { echo 'eq_height'; } ?>">
            <?php foreach ($related_recruits as $recruit) { ?>
				<div class="item recruit_post">
                <?php if(($recruit['image']) && ($rel_thumb_status)){ ?>
