...
<div class="sub-header">
	<img src="/image/bg_sub_tin_tuc.jpg" alt="">
</div>
<div class="sub blogsub">
...
<div class="container">
  ...
  <?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
  	...
  	<?php if($blogs){ ?>
		<div class=" boxblog <?php if($category_id == 50) {echo 'style_blog';}?>">
        ...
        <div class="col-sm-5">
                ...
                <p><a href="<?php echo $blog['href']; ?>" class="btn btn-default"><?php echo $text_read_more; ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
                </div>
                  </div>
              </div> <!-- item ends -->
			<?php } ?>
