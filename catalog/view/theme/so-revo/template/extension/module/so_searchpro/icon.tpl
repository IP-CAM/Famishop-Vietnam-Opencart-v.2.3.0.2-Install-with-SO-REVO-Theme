...
<div class="dropdown search-icon">
   <a class="dropdown-toggle dropdown-menu-right" id="dropdownsearch" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
<i class="fa fa-search"></i>
  </a>
  <div class="dropdown-menu" aria-labelledby="dropdownsearch">
		<div id="sosearchpro-icon" class="sosearchpro-wrapper so-search search-pro <?php echo $additional_class; ?>">
