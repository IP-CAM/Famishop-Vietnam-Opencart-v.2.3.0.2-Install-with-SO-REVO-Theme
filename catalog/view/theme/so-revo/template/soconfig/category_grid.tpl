	...
	<div class="product-filter filters-panel">
	  <div class="row">
		...
		<div class="short-by-show form-inline text-right col-md-10 col-sm-12">
			...
			<div class="product-compare form-group hidden"><a href="<?php echo $compare; ?>" id="compare-total" class="btn btn-default"><i class="fa fa-retweet"></i> <?php echo $text_compare; ?></a></div>
