...
abstract class Controller {
	...
	public function __construct($registry) {
		$this->registry = $registry;
				...
				if( ! empty( $this->request->get[($this->config->get('mfilter_url_param')?$this->config->get('mfilter_url_param'):'mfp')] ) && ! $this->config->get('mfp_path_was_verificed') && isset( $this->request->get['route'] ) ) {
					preg_match( '/path\[([^]]*)\]/', $this->request->get[($this->config->get('mfilter_url_param')?$this->config->get('mfilter_url_param'):'mfp')], $mf_matches );
