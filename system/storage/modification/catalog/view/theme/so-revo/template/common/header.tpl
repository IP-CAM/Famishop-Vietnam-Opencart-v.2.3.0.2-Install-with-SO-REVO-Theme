...
<?php // Begin General CSS -----
	...
	$this->soconfig->addCss('catalog/view/theme/'.$theme.'/fonts/webico/webico-fonts.css');
	...
	$this->soconfig->addCss('catalog/view/javascript/slick/slick.css');
	$this->soconfig->addCss('catalog/view/javascript/slick/slick-theme.css');
...
<?php // Begin Themes Scripts ----
	...
	$this->soconfig->addJs('catalog/view/javascript/jquery/jquery-ui.js');
	...
	$this->soconfig->addJs('catalog/view/javascript/slick/slick.min.js');
	...
	if(isset($cssfile_status) && $cssfile_status ) {
